...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url('assets/'); ?>node_modules/tw-elements/dist/css/index.min.css">
...
<body>
    ...
    <div class="container lg:px-4">
      <div class="flex flex-wrap">
        ...
        <div class="w-full px-4 mb-12 md:w-1/3 text-slate-300">
          ...
          <ul>
            <li>
              <a href="#!" class="inline-block text-base hover:text-sky-500 mb-3">Komunikasi</a>
            </li>
            <li>
              <a href="#!" class="inline-block text-base hover:text-sky-500 mb-3">Penyelesaian Masalah</a>
            </li>
            <li>
              <a href="#!" class="inline-block text-base hover:text-sky-500 mb-3">Berpikir Kritis</a>
            </li>
            <li>
              <a href="#!" class="inline-block text-base hover:text-sky-500 mb-3">Manajemen Waktu</a>
            </li>
          </ul>
        </div>
        <div class="w-full px-4 mb-12 md:w-1/3 text-slate-300">
          ...
          <ul>
            <li>
              <a href="#" class="inline-block text-base hover:text-sky-500 mb-3">Beranda</a>
            </li>
            <li>
              <a href="#keunggulan" class="inline-block text-base hover:text-sky-500 mb-3">Keunggulan</a>
            </li>
            <li>
              <a href="#harga" class="inline-block text-base hover:text-sky-500 mb-3">Harga</a>
            </li>
            <li>
              <a href="#portfolio" class="inline-block text-base hover:text-sky-500 mb-3">Portfolio</a>
            </li>
            <li>
              <a href="#testi" class="inline-block text-base hover:text-sky-500 mb-3">Testimonials</a>
            </li>
            <li>
              <a href="#kontak" class="inline-block text-base hover:text-sky-500 mb-3">Kontak Kami</a>
            </li>
            <li>
              <a href="#clients" class="inline-block text-base hover:text-sky-500 mb-3">Clients</a>
            </li>
          </ul>
        </div>
      </div>
  ...
  <script src="<?= base_url('assets/'); ?>dist/script.js"></script>
</body>
